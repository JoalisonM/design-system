const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/axe-BB4P8kR8.js","assets/_commonjsHelpers-CcAunmGO.js"])))=>i.map(i=>d[i]);
...
var { document } = global, channel = addons.getChannel(), active = false, activeStoryId, defaultParameters = { config: {}, options: {} }, handleRequest = async (storyId, input) => {
  ...
  try {
    if (!active) {
      ...
      let { default: axe } = await __vitePreload(() => import("./axe-BB4P8kR8.js").then((n) => n.a), true ? __vite__mapDeps([0,1]) : void 0), { element = "#storybook-root", config, options = {} } = input, htmlElement = document.querySelector(element);
