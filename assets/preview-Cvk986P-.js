const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/axe-d30qRy-n.js","assets/_commonjsHelpers-DWwsNxpa.js"])))=>i.map(i=>d[i]);
...
var { document } = global, channel = addons.getChannel(), defaultParameters = { config: {}, options: {} }, disabledRules = ["region"], queue = [], isRunning = false, runNext = async () => {
  ...
  let { default: axe } = await __vitePreload(async () => {
    const { default: axe2 } = await import("./axe-d30qRy-n.js").then((n) => n.a);
    return { default: axe2 };
  }, true ? __vite__mapDeps([0,1]) : void 0), { element = "body", config = {}, options = {} } = input, htmlElement = document.querySelector(element) ?? document.body;
      ...
      if (reporting.addReport({ type: "a11y", version: 1, result, status: hasViolations ? getMode() : "passed" }), getIsVitestStandaloneRun() && hasViolations && getMode() === "failed") {
        if (!vitestMatchersExtended) {
          let { toHaveNoViolations } = await __vitePreload(async () => {
            const { toHaveNoViolations: toHaveNoViolations2 } = await import("./matchers-57EZJSQE-CLfmPezH.js");
