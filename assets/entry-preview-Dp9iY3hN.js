const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/react-18-BJuFiAvZ.js","assets/index-XyBrGLi6.js","assets/_commonjsHelpers-DWwsNxpa.js","assets/index-CVqyR_EW.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./iframe-Cesnnl0B.js";
import { _ as __toESM, a as __commonJS, d as __export } from "./chunk-XP5HYGXS-CQBei2qV.js";
import { a as requireReact, r as reactExports, R as React } from "./index-XyBrGLi6.js";
 ...
 */
var hasRequiredReactDomTestUtils_production;
function requireReactDomTestUtils_production() {
  if (hasRequiredReactDomTestUtils_production) return reactDomTestUtils_production;
  hasRequiredReactDomTestUtils_production = 1;
  ...
  return reactDomTestUtils_production;
}
...
function requireTestUtils() {
  ...
  {
    testUtils.exports = requireReactDomTestUtils_production();
  }
...
async function renderToCanvas({ storyContext, unboundStoryFn, showMain, showException, forceRemount }, canvasElement) {
  let { renderElement, unmountElement } = await __vitePreload(async () => {
    const { renderElement: renderElement2, unmountElement: unmountElement2 } = await import("./react-18-BJuFiAvZ.js");
    return { renderElement: renderElement2, unmountElement: unmountElement2 };
  }, true ? __vite__mapDeps([0,1,2,3]) : void 0), Story = unboundStoryFn, content = storyContext.parameters.__isPortableStory ? React.createElement(Story, { ...storyContext }) : React.createElement(ErrorBoundary, { showMain, showException }, React.createElement(Story, { ...storyContext })), element = Wrapper ? React.createElement(Wrapper, null, content) : content;
...
var parameters = { renderer: "react" }, decorators = [(story, context) => {
  ...
  try {
    let { configure } = await __vitePreload(async () => {
      const { configure: configure2 } = await import("./index-CVCQkCk7.js").then((n) => n.a);
