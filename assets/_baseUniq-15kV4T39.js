...
function getLuminance(color) {
  ...
  }), r = _Object$keys$map[0], g2 = _Object$keys$map[1], b = _Object$keys$map[2];
  return parseFloat((0.2126 * r + 0.7152 * g2 + 0.0722 * b).toFixed(3));
}
...
export {
  ...
  isArray_1 as E,
  _baseUniq as F,
  curriedTransparentize$1 as G,
  curriedDarken$1 as H,
  curriedOpacify$1 as I,
  curriedLighten$1 as J,
  rgba as K,
  _baseGetTag as L,
  get$2 as M,
  isObject$4 as N,
